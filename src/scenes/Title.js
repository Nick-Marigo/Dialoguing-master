class Title extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('bob', 'img/bobthebuilder.webp')

        // load bitmap font
        this.load.bitmapFont('gem_font', 'font/gem.png', 'font/gem.xml')
        this.load.bitmapFont('wm_font', 'font/winkymilky.png', 'font/winkymilky.xml')
    }

    create() {
        // add title text
        this.add.bitmapText(centerX, centerY - 32, 'wm_font', 'A MIDSUMMER NIGHT\'S DREAM', 48).setOrigin(0.5)
        this.add.bitmapText(centerX, centerY + 16, 'wm_font', 'Press SPACE to start', 32).setOrigin(0.5)
